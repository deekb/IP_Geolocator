...
static PyCodeObject *codeobj_8a3e1a2bd9722cf2c3a4eb1ee8974910;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[35]); CHECK_OBJECT(module_filename_obj);
    codeobj_8a3e1a2bd9722cf2c3a4eb1ee8974910 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[36], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_8a3e1a2bd9722cf2c3a4eb1ee8974910;
    ...
    // Frame without reuse.
    frame_8a3e1a2bd9722cf2c3a4eb1ee8974910 = MAKE_MODULE_FRAME(codeobj_8a3e1a2bd9722cf2c3a4eb1ee8974910, module_cryptography$hazmat$primitives$ciphers);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_8a3e1a2bd9722cf2c3a4eb1ee8974910);
    assert(Py_REFCNT(frame_8a3e1a2bd9722cf2c3a4eb1ee8974910) == 2);
    ...
    // Framed code:
    {
        ...
        frame_8a3e1a2bd9722cf2c3a4eb1ee8974910->m_frame.f_lineno = 1;
        {
    ...
    }
    {
        ...
        UPDATE_STRING_DICT1(moduledict_cryptography$hazmat$primitives$ciphers, (Nuitka_StringObject *)mod_consts[21], tmp_assign_source_6);
    }
    {
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        frame_8a3e1a2bd9722cf2c3a4eb1ee8974910->m_frame.f_lineno = 7;
    ...
    }
    {
        ...
        UPDATE_STRING_DICT1(moduledict_cryptography$hazmat$primitives$ciphers, (Nuitka_StringObject *)mod_consts[31], tmp_assign_source_15);
    }
    {
        ...
        UPDATE_STRING_DICT1(moduledict_cryptography$hazmat$primitives$ciphers, (Nuitka_StringObject *)mod_consts[32], tmp_assign_source_16);
    }
    goto try_end_1;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_8a3e1a2bd9722cf2c3a4eb1ee8974910);
#endif
    popFrameStack();

    assertFrameObject(frame_8a3e1a2bd9722cf2c3a4eb1ee8974910);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_8a3e1a2bd9722cf2c3a4eb1ee8974910, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_8a3e1a2bd9722cf2c3a4eb1ee8974910->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_8a3e1a2bd9722cf2c3a4eb1ee8974910, exception_lineno);
    }
    ...
    tmp_import_from_2__module = NULL;
    {
        ...
        tmp_assign_source_17 = LIST_COPY(mod_consts[33]);
        UPDATE_STRING_DICT1(moduledict_cryptography$hazmat$primitives$ciphers, (Nuitka_StringObject *)mod_consts[34], tmp_assign_source_17);
    }
