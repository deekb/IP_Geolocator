...
static PyCodeObject *codeobj_c07f7cf0b9d6891bce051d631ca7e878;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[99]); CHECK_OBJECT(module_filename_obj);
    codeobj_c07f7cf0b9d6891bce051d631ca7e878 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[100], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_c07f7cf0b9d6891bce051d631ca7e878;
    ...
    // Frame without reuse.
    frame_c07f7cf0b9d6891bce051d631ca7e878 = MAKE_MODULE_FRAME(codeobj_c07f7cf0b9d6891bce051d631ca7e878, module_chardet$mbcssm);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_c07f7cf0b9d6891bce051d631ca7e878);
    assert(Py_REFCNT(frame_c07f7cf0b9d6891bce051d631ca7e878) == 2);
    ...
    }
    {
        ...
        frame_c07f7cf0b9d6891bce051d631ca7e878->m_frame.f_lineno = 28;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_c07f7cf0b9d6891bce051d631ca7e878);
#endif
    popFrameStack();

    assertFrameObject(frame_c07f7cf0b9d6891bce051d631ca7e878);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_c07f7cf0b9d6891bce051d631ca7e878, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_c07f7cf0b9d6891bce051d631ca7e878->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_c07f7cf0b9d6891bce051d631ca7e878, exception_lineno);
    }
