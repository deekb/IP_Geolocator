...
static void createModuleCodeObjects(void) {
    ...
    codeobj_14b96acaca702364cfb034a9292d7770 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[60], NULL, NULL, 0, 0, 0);
    codeobj_aac9d7fded95a6b55bd55803bd07bd60 = MAKE_CODEOBJECT(module_filename_obj, 43, CO_NOFREE, mod_consts[0], mod_consts[61], NULL, 0, 0, 0);
    codeobj_37db29209ffa57cb1da846d165253c13 = MAKE_CODEOBJECT(module_filename_obj, 44, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[1], mod_consts[62], NULL, 1, 0, 0);
}
...
static PyObject *impl_chardet$sbcsgroupprober$$$function__1___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        tmp_assattr_value_1 = PyList_New(12);
        {
            ...
            tmp_list_element_1 = CALL_FUNCTION_WITH_SINGLE_ARG(tmp_called_value_5, tmp_args_element_value_5);
            if (tmp_list_element_1 == NULL) {
                assert(ERROR_OCCURRED());
            ...
            tmp_list_element_1 = CALL_FUNCTION_WITH_SINGLE_ARG(tmp_called_value_9, tmp_args_element_value_9);
            if (tmp_list_element_1 == NULL) {
                assert(ERROR_OCCURRED());
            ...
            tmp_list_element_1 = CALL_FUNCTION_WITH_SINGLE_ARG(tmp_called_value_10, tmp_args_element_value_10);
            if (tmp_list_element_1 == NULL) {
                assert(ERROR_OCCURRED());
            ...
            tmp_list_element_1 = CALL_FUNCTION_WITH_SINGLE_ARG(tmp_called_value_12, tmp_args_element_value_12);
            if (tmp_list_element_1 == NULL) {
                assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_assign_source_1 = CALL_FUNCTION_NO_ARGS(tmp_called_value_13);
    ...
    }
    {
        ...
        if (unlikely(tmp_args_element_value_13 == NULL)) {
            tmp_args_element_value_13 = GET_MODULE_VARIABLE_VALUE_FALLBACK(mod_consts[17]);
        }
        ...
        frame_37db29209ffa57cb1da846d165253c13->m_frame.f_lineno = 65;
        {
            ...
            tmp_assign_source_2 = CALL_FUNCTION_WITH_ARGS3(tmp_called_value_14, call_args);
        }
    ...
    }
    {
        ...
        frame_37db29209ffa57cb1da846d165253c13->m_frame.f_lineno = 67;
        {
            ...
            tmp_assign_source_3 = CALL_FUNCTION_WITH_ARGS3(tmp_called_value_15, call_args);
        }
    ...
    }
    {
        ...
        tmp_call_result_3 = CALL_METHOD_WITH_SINGLE_ARG(tmp_called_instance_3, mod_consts[19], tmp_args_element_value_21);
...
PyObject *modulecode_chardet$sbcsgroupprober(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
// Mark the execution in the "__spec__" value.
    ...
    branch_end_2:;
    {
        ...
        tmp_res = PyObject_SetItem(locals_chardet$sbcsgroupprober$$$class__1_SBCSGroupProber_43, mod_consts[56], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
        ...
        tmp_res = PyObject_SetItem(locals_chardet$sbcsgroupprober$$$class__1_SBCSGroupProber_43, mod_consts[58], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
